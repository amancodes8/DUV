...
function Contact() {
  return (
    <div className='w-screen h-fit py-10 px-5 mt-20 flex flex-col gap-16 justify-center items-center overflow-x-hidden overflow-y-auto text-white'>

      {/* Hero Section */}
      <div className='w-full h-[50vh] flex flex-col justify-center items-center bg-gradient-to-r from-purple-700 to-blue-600'>
        <h1 className='text-5xl font-bold text-white drop-shadow-lg'>Get In Touch With Us</h1>
        <p className='text-xl mt-4 text-gray-200 drop-shadow-lg'>
          We're here to help and answer any questions you might have. We look forward to hearing from you!
        </p>
      </div>

      {/* Contact Form Section */}
      <div className='w-full lg:w-[60%] bg-gray-800 p-10 rounded-lg shadow-2xl'>
      ...
      <div className='w-full lg:w-[80%] flex flex-col lg:flex-row justify-between items-start gap-10'>
        <div className='w-full lg:w-1/3 p-6 bg-gradient-to-r from-gray-900 to-gray-700 rounded-lg shadow-lg'>
          ...
          <p className='text-lg mb-4 flex items-center'>
            ...
            <a className='ml-3 text-blue-400 hover:underline' href="https://facebook.com" target="_blank" rel="noopener noreferrer">
      ...
      <div className='w-full lg:w-[80%]'>
        <h2 className='text-4xl mb-10 text-white'>Frequently Asked Questions (FAQs)</h2>
        <div className='space-y-5'>
          <div>
            <h3 className='text-2xl font-semibold text-white'>How can I reach customer support?</h3>
            <p className='text-gray-300'>You can reach us through the contact form above, or by calling us at +9196253 96652 during School hours.</p>
          </div>
          <div>
            <h3 className='text-2xl font-semibold text-white'>What is the response time?</h3>
            <p className='text-gray-300'>We aim to respond to all inquiries within 24-48 hours.</p>
          </div>
          <div>
            <h3 className='text-2xl font-semibold text-white'>Where are you located?</h3>
            <p className='text-gray-300'>We are located at HCR6+M9W, Parthala Khanjarpur, Sector 123, Noida, Uttar Pradesh 201307. Visit us during School hours!</p>
          </div>
        </div>
      </div>
      ...
      <div className='w-full lg:w-[80%] flex flex-col gap-5'>
        <h2 className='text-4xl text-white'>Additional Information</h2>
        ...
        <p className='text-lg text-gray-300'>
          We are constantly expanding our services to better serve our customers. Stay tuned for updates and new features coming soon!
        </p>
      </div>
